...
public class Point {
	...
	/**
	 * Utility method to export coordinates for use with GeoJSON. This standard
	 * requires longitude first. See
	...
	/**
	 * We consider that two point are equals if both latitude and longitude are
	 * "nearly" the same. With a precision of 1e-3 degree
	 */
	@Override
